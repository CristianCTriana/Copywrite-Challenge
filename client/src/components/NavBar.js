...
export default function NavBar () {
  ...
  return (
    <nav className='navbar navbar-expand-lg bg-light'>
      <input className='form-control' onChange={(event) => { handleInputChange(event) }} onKeyUp={(event) => { if (event.code === 'Enter') handleSubmit(event) }} value={text} type='text' placeholder='Text ...' />
